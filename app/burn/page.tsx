...
export default function BurnPage() {
  ...
  // Guard ref to prevent multiple transaction firings
  ...
  }, [sprinklesReceipt, refetchSprinklesAuction, refetchPendingDonut, resetSprinklesWrite, showSprinklesResult, sprinklesTxStep, resetSprinklesState]);

  // Trigger buy after approval - with guard
  useEffect(() => {
    if (
