    ...
    <main className="flex h-screen w-screen justify-center overflow-hidden bg-black font-mono text-white select-none">
      ...
      >
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          {gameState === "playing" && <div className="absolute bottom-4 left-0 right-0 text-center pointer-events-none z-20"><p className="text-zinc-500 text-xs bg-black/50 inline-block px-3 py-1 rounded-full">Hold left/right to move</p></div>}
        </div>
