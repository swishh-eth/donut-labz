                        ...
                        <div className={cn(
                          ...
                          <div className="flex items-center gap-2 mb-1">
                            <span className={cn(
                              ...
                              {splitResult === "rewarded" 
                                ? <span className="flex items-center gap-1"><SprinklesCoin className="w-4 h-4" /> +10 SPRINKLES!</span>
                                : splitResult === "success"
                                  ? "Split Complete!"
                                  : splitResult === "failure"
                                    ? "Split Failed"
                          ...
                          <div className={cn(
                            ...
                            {splitResult === "rewarded"
                              ...
                              : !!(splitterBalance && splitterBalance > 0n)
                                ...
                                : <span className="flex items-center gap-1">Split the Sprinkles App miner fee to earn</span>}
                          </div>
                          <div className="text-[8px] text-gray-500 mt-1">
                            Hold 10K Sprinkles • Gas cost only
                          </div>
                        </div>
                      </div>
                    </div>
