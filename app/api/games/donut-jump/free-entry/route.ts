// Place in: app/api/games/donut-jump/free-entry/route.ts
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[Donut Jump] New entry created:", entryId, "for fid:", fid, "week:", currentWeek);
    ...
    console.error("[Donut Jump] Free entry error:", error);
    return NextResponse.json(
