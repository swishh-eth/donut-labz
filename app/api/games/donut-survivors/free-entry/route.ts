// Place in: app/api/games/donut-survivors/free-entry/route.ts
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[Donut Survivors] New entry created:", entryId, "for fid:", fid, "week:", currentWeek);
    ...
    console.error("[Donut Survivors] Free entry error:", error);
    return NextResponse.json(
